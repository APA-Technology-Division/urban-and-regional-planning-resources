...
- [Waypoint](https://www.waypointtransit.com/) - An AI platform for city planning that helps planners automate routine workflows, connect planning data sources, and run geospatial analyses, permitting reviews, corridor studies, safety audits, and custom reports. Additional Information: License: Proprietary; Provider: Waypoint.
