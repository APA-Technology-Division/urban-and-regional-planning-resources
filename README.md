...
- [Mapping Inequality](https://dsl.richmond.edu/panorama/redlining/#loc=5/39.1/-94.58) - An interactive map that layers georectified Home Owners' Loan Corporation (HOLC) maps onto a modern basemap of the United States. These color coded HOLC maps were a physical embodiment of the real estate practice known as *redlining,* for a complete description see the [Introduction](https://dsl.richmond.edu/panorama/redlining/#loc=5/39.1/-94.58&text=intro). For some cities, the accompanying demographic data and descriptions of individual neighboorhoods are available. The GIS data is also available for download as Shapefile or GeoJSON. Additional Information: License: CC BY-NC-SA 4.0, Geographic Coverage: Major Metropolitan Areas in the Lower 48 US States (1935-1940), [Download](http://dsl.richmond.edu/panorama/redlining/#text=downloads), [Introduction](https://dsl.richmond.edu/panorama/redlining/#loc=5/39.1/-94.58&text=intro).
