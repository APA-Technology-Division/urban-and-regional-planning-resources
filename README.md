...
- [SafeStreets](https://safestreets.streetsandcommons.com) - A free web platform providing address-level walkability and pedestrian-safety scores on a 15-minute-city framework (daily-needs reach, pedestrian safety, transit access, walking comfort), with crash-based pedestrian risk analysis, built on OpenStreetMap and public datasets.
